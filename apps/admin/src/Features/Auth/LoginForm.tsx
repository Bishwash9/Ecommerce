...
export const LoginForm = () => {
  ...
  const { register, handleSubmit, setError, clearErrors, formState: { errors, isSubmitting }, } = useForm<LoginData>({
  ...
  const onSubmit = async (data: LoginData) => {
    clearErrors('root.server'); //clear any previous server errors
